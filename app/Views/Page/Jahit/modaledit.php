...
<div class="modal fade" id="modaledit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <?= form_open_multipart('Back/Jahit/updatedata', ['class' => 'formedit']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                ...
                <div style="display: none;" class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input value="<?= $id_jahit ?>" style="color:black;" type="text" name="id" id="id"
                            class="form-control">
                ...
                <div class="form-group row">
                    <label style=" color:black;" for="jumlah_jahitan" class="col-sm-2 col-form-label">Jumlah Jahitan
                    </label>
                    <div class="col-sm-8">
                        <input value="<?= $jumlah_jahitan ?>" style=" color:black;" type="text" name="jumlah_jahitan"
                            id="jumlah_jahitan" class="form-control">
                        <div class="invalid-feedback errorjumlah_jahitan">
                        </div>
                    </div>
                </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        if (response.error.jumlah_jahitan) {
                            $('#jumlah_jahitan').addClass('is-invalid');
                            $('.errorjumlah_jahitan').html(response.error.jumlah_jahitan);
                        } else {
                            $('#jumlah_jahitan').removeClass('is-invalid');
                            $('.errorjumlah_jahitan').html('');
                        }
