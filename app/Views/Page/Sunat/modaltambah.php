...
<div class="modal fade" id="modaltambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Data Sunat</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <label style=" color:black;" for="jenis_sunat" class="col-sm-2 col-form-label">Jenis Sunat
                    </label>
                    <div class="col-sm-8">
                        <input style=" color:black;" placeholder="ex: Sunat Leser" type="text" name="jenis_sunat"
                            id="jenis_sunat" class="form-control">
                        <div class="invalid-feedback errorjenis_sunat">
                        </div>
                    </div>
                </div>
    ...
    $(document).ready(function() {
        ...
        $(".formtambah").submit(function(e) {
            ...
            $.ajax({
                type: "post",
                url: "<?= site_url('Back/Sunat/simpandata') ?>",
                data: data,
                processData: false,
                contentType: false,
                cache: false,
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        if (response.error.jenis_sunat) {
                            $('#jenis_sunat').addClass('is-invalid');
                            $('.errorjenis_sunat').html(response.error.jenis_sunat);
                        } else {
                            $('#jenis_sunat').removeClass('is-invalid');
                            $('.errorjenis_sunat').html('');
                        }
