...
<div class="modal fade" id="modaledit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <?= form_open_multipart('Back/Sunat/updatedata', ['class' => 'formedit']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                ...
                <div style="display: none;" class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input value="<?= $id_sunat ?>" style="color:black;" type="text" name="id" id="id"
                            class="form-control">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input value="<?= $jenis_sunat ?>" style=" color:black;" type="text" name="jenis_sunat"
