    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Data Cek Asamurat</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <?= form_open_multipart('Back/Asamurat/updatedata', ['class' => 'formedit']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                ...
                <div style="display: none;" class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input value="<?= $id_asamurat ?>" style="color:black;" type="text" name="id" id="id"
                            class="form-control">
                ...
                <div class="form-group row">
                    <label style=" color:black;" for="nilai_asamurat" class="col-sm-2 col-form-label">Nilai Asamurat
                    </label>
                    <div class="col-sm-8">
                        <input value="<?= $nilai_asamurat ?>" style=" color:black;" type="text" name="nilai_asamurat"
                            id="nilai_asamurat" class="form-control">
                        <div class="invalid-feedback errornilai_asamurat">
                        </div>
                    </div>
                </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        if (response.error.nilai_asamurat) {
                            $('#nilai_asamurat').addClass('is-invalid');
                            $('.errornilai_asamurat').html(response.error.nilai_asamurat);
                        } else {
                            $('#nilai_asamurat').removeClass('is-invalid');
                            $('.errornilai_asamurat').html('');
                        }
