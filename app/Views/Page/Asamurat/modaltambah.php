...
<div class="modal fade" id="modaltambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Cek Asamurat</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <?= form_open_multipart('Back/Operasi/simpandata', ['class' => 'formtambah']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input style=" color:black;" type="text" placeholder="ex: 6,3" name="nilai_asamurat"
    ...
    $(document).ready(function() {
        ...
        $(".formtambah").submit(function(e) {
            ...
            $.ajax({
                type: "post",
                url: "<?= site_url('Back/Asamurat/simpandata') ?>",
                data: data,
                processData: false,
                contentType: false,
                cache: false,
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        if (response.error.nilai_asamurat) {
                            ...
                            $('.nilai_asamurat').html(response.error.nilai_asamurat);
                        } else {
