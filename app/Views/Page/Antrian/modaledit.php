...
<div class="modal fade" id="modaledit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <?= form_open_multipart('Back/Antrian/updatedata', ['class' => 'formedit']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                <div style="display: none;" class="form-group row">
                    <label style=" color:black;" for="id" class="col-sm-2 col-form-label"></label>
                    <div class="col-sm-8">
                        <input value="<?= $id_riwayat ?>" style="color:black;" type="text" name="id" id="id"
                            class="form-control">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input value="<?= $nama_layanan ?>" disabled style="color:black;" type="text" name="nama_pasien"
                            id="nama_pasien" class="form-control">
                        <div class="invalid-feedback errornama_pasien">
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input value="0" required style="color:black;" type="number" name="biaya_lainya"
                            id="biaya_lainya" class="form-control">
                ...
                <div style="display: none;" class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input value="<?= $total_harga ?>" style=" color:black;" type="text" name="total_harga"
                            id="total_harga" class="form-control">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input disabled value="<?= $total_harga ?>" style=" color:black;" type="text"
                            name="total_harga2" id="total_harga2" class="form-control">
                ...
                <div style="display: none;" class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input value="<?= $total_harga ?>" style=" color:black;" type="text" name="total_harga1"
                            id="total_harga1" class="form-control">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input value="0" required style=" color:black;" type="number" name="total_bayar"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input value="0" disabled style=" color:black;" type="text" name="kembalian1" id="kembalian1"
                            class="form-control">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input required value="<?= $keterangan ?>" style=" color:black;" type="text" name="keterangan"
