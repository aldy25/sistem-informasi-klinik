...
<div class="modal fade" id="modaltambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Surat Izin Sakit </h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <label style=" color:black;" for="durasi" class="col-sm-2 col-form-label">Durasi
                    </label>
                    <div class="col-sm-8">
                        <input style=" color:black;" type="text" placeholder="ex: 3 Hari" name="durasi" id="durasi"
                            class="form-control">
                ...
                <div class="form-group row">
                    <label style=" color:black;" for="waktu_awal" class="col-sm-2 col-form-label">Waktu Awal </label>
                    <div class="col-sm-8">
                        <input style=" color:black;" type="date" name="waktu_awal" id="waktu_awal" class="form-control">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input style=" color:black;" type="date" name="waktu_akhir" id="waktu_akhir"
                            class="form-control">
    ...
    $(document).ready(function() {
        ...
        $(".formtambah").submit(function(e) {
            ...
            $.ajax({
                type: "post",
                url: "<?= site_url('Back/Sakit/simpandata') ?>",
                data: data,
                processData: false,
                contentType: false,
                cache: false,
