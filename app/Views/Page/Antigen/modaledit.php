    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Data Tes Antigen</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <?= form_open_multipart('Back/Antigen/updatedata', ['class' => 'formedit']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                ...
                <div style="display: none;" class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input value="<?= $id_antigen ?>" style="color:black;" type="text" name="id" id="id"
                            class="form-control">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input value="<?= $parameter ?>" style=" color:black;" type="text" name="parameter"
                            id="parameter" class="form-control">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input value="<?= $hasil ?>" style=" color:black;" type="text" name="hasil" id="hasil"
                            class="form-control">
