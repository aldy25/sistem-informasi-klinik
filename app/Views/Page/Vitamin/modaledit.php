    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Data Suntik Vitamin</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <?= form_open_multipart('Back/Vitamin/updatedata', ['class' => 'formedit']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                ...
                <div style="display: none;" class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input value="<?= $id_vitamin ?>" style="color:black;" type="text" name="id" id="id"
                            class="form-control">
                ...
                <div class="form-group row">
                    <label style=" color:black;" for="nama_vitamin" class="col-sm-2 col-form-label">Nama Vitamin
                    </label>
                    <div class="col-sm-8">
                        <input value="<?= $nama_vitamin ?>" style=" color:black;" type="text" name="nama_vitamin"
                            id="nama_vitamin" class="form-control">
                        <div class="invalid-feedback errornama_vitamin">
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <label style=" color:black;" for="dosis" class="col-sm-2 col-form-label">Dosis
                    </label>
                    <div class="col-sm-8">
                        <input value="<?= $dosis ?>" style=" color:black;" type="text" name="dosis" id="dosis"
                            class="form-control">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        if (response.error.nama_vitamin) {
                            $('#nama_vitamin').addClass('is-invalid');
                            $('.errornama_vitamin').html(response.error.nama_vitamin);
                        } else {
                            $('#nama_vitamin').removeClass('is-invalid');
                            $('.errornama_vitamin').html('');
                        }
                        if (response.error.dosis) {
                            $('#dosis').addClass('is-invalid');
                            $('.errordosis').html(response.error.dosis);
                        } else {
