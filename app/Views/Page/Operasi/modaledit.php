    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Data Operasi kecil</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <?= form_open_multipart('Back/Operasi/updatedata', ['class' => 'formedit']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                ...
                <div style="display: none;" class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input value="<?= $id_operasi ?>" style="color:black;" type="text" name="id" id="id"
                            class="form-control">
                ...
                <div class="form-group row">
                    <label style=" color:black;" for="nama_operasi" class="col-sm-2 col-form-label">Nama Operasi
                    </label>
                    <div class="col-sm-8">
                        <input value="<?= $nama_operasi ?>" style=" color:black;" type="text" name="nama_operasi"
                            id="nama_operasi" class="form-control">
                        <div class="invalid-feedback errornama_operasi">
                        </div>
                    </div>
                </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        if (response.error.nama_operasi) {
                            $('#nama_operasi').addClass('is-invalid');
                            $('.errornama_operasi').html(response.error.nama_operasi);
                        } else {
                            $('#nama_operasi').removeClass('is-invalid');
                            $('.errornama_operasi').html('');
                        }
