            ...
            <div class="card-body">
                <div class="card-title">
                    <button style="background-color: green; color:white;" type="button" class="btn btn-sm tomboltambah">
                        <i class="fa fa-plus-circle"></i> Tambah Pertandingan
                    </button>
                    <button style="background-color: green; color:white;" type="button" class="btn btn-sm tomboltambahbanyak">
                        <i class="fa fa-plus-circle"></i> Tambah Banyak Pertandingan
                    </button>
                </div>
...
<script>
    function dataPertandingan() {
        $.ajax({
            url: "<?= site_url('Pertandingan/ambildata') ?>",
            dataType: "json",
    ...
    $(document).ready(function() {
        ...
        $('.tomboltambah').click(function(e) {
            e.preventDefault();
            $.ajax({
                url: "<?= site_url('Pertandingan/formtambah') ?>",
                dataType: "json",
                success: function(response) {
        ...
        $('.tomboltambahbanyak').click(function(e) {
            e.preventDefault();
            $.ajax({
                url: "<?= site_url('Pertandingan/formtambahbanyak') ?>",
                dataType: "json",
                success: function(response) {
                    $('.viewmodal').html(response.data).show();
                    $('#modaltambahbanyak').modal('show');
                },
                error: function(xhr, ajaxOptions, thrownError) {
                    alert(xhr.status + "\n" + xhr.responseText + "\n" + thrownError);
                }
