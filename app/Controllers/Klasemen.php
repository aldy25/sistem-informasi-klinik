...
use Config\Services;
use App\Models\Modeldataklasemen;
...
class Klasemen extends BaseController
{
    ...
    {
        $data = [
            'title' => 'SISTEM INFORMASI KLASEMEN SEPAKBOLA | DATA KLASEMEN',
            'page' => 'KLASEMEN'
        ];
        return view('Page/Klasemen/Viewdata', $data);
    }
    public function ambildata()
    {
        if ($this->request->isAJAX()) {
            $data = [
                'tampildata' => $this->Klasemen->findAll()
            ];
            $msg = [
                'data' => view('Page/Klasemen/Data', $data)
            ];
    ...
    public function listdata()
    {
        ...
        $datamodel = new Modeldataklasemen($request);
